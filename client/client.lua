...
RegisterNetEvent('qr-weathersync:client:DisableSync', function()
	disable = true
	CreateThread(function()
		while disable do
            Citizen.InvokeNative(0x193DFC0526830FD6, 0.0) -- SetRainLevel
			Wait(5000)
		end
	end)
end)
...
RegisterNetEvent('qr-weathersync:client:RequestCommands', function(isAllowed)
    if isAllowed then
