...
local Translations = {
	weather = {
		...
		invalid = "Invalid weather type, valid weather types are: \nblizzard, clouds, drizzle, fog, groundblizzard, hail, highpressure, hurricane, misty, overcast, overcastdark, rain, sandstorm, shower, sleet, snow, snowlight, sunny, thunder thunderstorm & whiteout",
	...
	help = {
		...
		availableweather = "Available types: blizzard, clouds, drizzle, fog, groundblizzard, hail, highpressure, hurricane, misty, overcast, overcastdark, rain, sandstorm, shower, sleet, snow, snowlight, sunny, thunder thunderstorm & whiteout",
